...
class LifeHacksImages extends StatefulWidget {
  @override
  _LifeHacksImagesState createState() => _LifeHacksImagesState();
}

class _LifeHacksImagesState extends State<LifeHacksImages> {
  final fb = FirebaseFirestore.instance;

  fetchImage() async {
    var res = await fb.collection('LifeHacksImages').doc().get();
    return res;
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<QuerySnapshot>(
      future: fb.collection('LifeHacksImages').get(),
